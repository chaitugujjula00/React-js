        ...
        <div className="w-full  rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 bg-pink-300 border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="POST">
                  ...
                  <button type="submit" onClick={submit} className="w-full text-white bg-primary-600 border-2 border-gray-600  focus:ring-4 focus:outline-none focus:ring-primary-300  font-medium rounded-lg text-base px-5 py-2.5 text-center  hover:border-2 hover:border-pink-500 hover:bg-pink-400">Sign in</button>
