    ...
    <div>
      {items.map((item) => (
        <div key={item.card.info.id} >
                <button className="absolute  mt-36 right-[100px] text-black bg-gray-300 border border-red-600 py-2 px-3 rounded-xl"
          ...
          <div className=" m-4 bg-white rounded-xl flex justify-between p-4 shadow-inner">
                ...
                <div className="w-[22.5%] px-4">
                        <img className="rounded-xl bg-cover h-36 w-full" src={CDN_URL + item.card.info.imageId} />
